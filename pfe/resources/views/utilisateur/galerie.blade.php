                ...
                <div class="col s12 m6 l4">
                    <div class="qt-part-archive-item qt-item-chart">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bg" data-bgimage="{{asset('utilisateur/imagestemplate/gallerie/02.jpg')}}">
                                <img src="{{asset('utilisateur/imagestemplate/gallerie/02.jpg')}}" alt="Featured image" width="690" height="690">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l4">
                    <div class="qt-part-archive-item qt-item-chart">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bg" data-bgimage="{{asset('utilisateur/imagestemplate/gallerie/03.jpg')}}">
                                <img src="{{asset('utilisateur/imagestemplate/gallerie/03.jpg')}}" alt="Featured image" width="690" height="690">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l4">
                    <div class="qt-part-archive-item qt-item-chart">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bg" data-bgimage="{{asset('utilisateur/imagestemplate/gallerie/04.jpg')}}">
                                <img src="{{asset('utilisateur/imagestemplate/gallerie/04.jpg')}}" alt="Featured image" width="690" height="690">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l4">
                    <div class="qt-part-archive-item qt-item-chart">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bg" data-bgimage="{{asset('utilisateur/imagestemplate/gallerie/05.jpg')}}">
                                <img src="{{asset('utilisateur/imagestemplate/gallerie/05.jpg')}}" alt="Featured image" width="690" height="690">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l4">
                    <div class="qt-part-archive-item qt-item-chart">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bg" data-bgimage="{{asset('utilisateur/imagestemplate/gallerie/06.jpg')}}">
                                <img src="{{asset('utilisateur/imagestemplate/gallerie/06.jpg')}}" alt="Featured image" width="690" height="690">
                            </div>
                        </div>
                    </div>
                </div>
