                                ...
                                <div class="qt-part-archive-item qt-part-show-schedule-day-item">
                                    ...
                                    <div class="qt-overinfo qt-paper">
                                        <p class="qt-item-det qt-accent">
                                            <span class="qt-time">{{$programme->heure}}</span><span class="qt-am"></span><span class="qt-day qt-capfont">{{$programme->jours}}</span>
                                        </p>
                                        <div class="qt-more">
                                            <p class="qt-ellipsis-2">{{$programme->nomE}} {{$programme->prenomE}}</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- SCHEDULE SHOW END ========================= -->
