                ...
                <div class="col s12 m12 l8">
                    <ul class="collapsible qt-chart-tracklist" data-collapsible="accordion">
                        ...
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image2.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/2.png')); ?>" >
                            </div>
                        </li>
                        <!-- CHART TRACK END ========================= -->
                        <!-- CHART TRACK ========================= -->
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image3.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/3.png')); ?>" >
                            </div>
                        </li>
                        <!-- CHART TRACK END ========================= -->
                        <!-- CHART TRACK ========================= -->
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image4.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/4.png')); ?>" >
                            </div>
                        </li>
                        <!-- CHART TRACK END ========================= -->
                        <!-- CHART TRACK ========================= -->
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image6.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/9.png')); ?>" >
                            </div>
                        </li>
                        <!-- CHART TRACK END ========================= -->
                        <!-- CHART TRACK ========================= -->
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image5.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                        ...
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image7.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image8.png')); ?>" >
                            </div>
                        </li>
                        <!-- CHART TRACK END ========================= -->
                        <!-- CHART TRACK ========================= -->
                        <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                            <div class="qt-chart-table collapsible-header qt-content-primary">
                                <div class="qt-position">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/event/Image9.png')); ?>" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                    <span>03</span>
                                </div>
                                <div class="qt-titles">
                            ...
                            <div class="collapsible-body qt-paper">
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/5.png')); ?>" >
                                <img src="<?php echo e(asset('utilisateur/imagestemplate/event/6.png')); ?>" >
