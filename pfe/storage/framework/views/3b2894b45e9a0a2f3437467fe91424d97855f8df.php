                        ...
                        <div class="qt-part-archive-item qt-featured">
                            <div class="qt-item-header">
                                <div class="qt-header-top">
                                    <ul class="qt-tags">
                                        <li><a href="#"><?php echo e($actualite->titre); ?></a></li>
                                    </ul>
                                ...
                                <div class="qt-header-bottom">
                                    <div class="qt-item-metas">
                                        <a class="qt-author-thumb" href="#author-url">
                                            <img src="<?php echo e(asset('utilisateur/imagestemplate/actualites/actu.png')); ?>" alt="" width="30" height="30">
                                        </a>
                                        <div class="qt-texts">
                                ...
                                <div class="qt-header-bg" data-bgimage="<?php echo e(asset('utilisateur/imagestemplate/network.png')); ?>">
                                    <img src="<?php echo e(asset('utilisateur/imagestemplate/network.png')); ?>" alt="Featured image" width="690" height="302">
                                </div>
                            </div>
                            <div class="qt-item-content qt-card qt-the-content">
                                <p><?php echo e($actualite->description); ?></p>
