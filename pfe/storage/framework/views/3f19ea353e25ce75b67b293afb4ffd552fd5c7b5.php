                    ...
                    <div class="qt-part-archive-item">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bottom">
                                <div class="qt-item-metas">
                                    <a class="qt-author-thumb" href="#">
                                        <img src='<?php echo e(asset('utilisateur/imagestemplate/technopole.jpg')); ?>' alt="" width="30" height="30">
                                    </a>

                                </div>
                                <a href="#" class="qt-btn qt-btn-primary qt-readmore"><i class="dripicons-align-justify"></i></a>
                            </div>
                            <div class="qt-header-bg" data-bgimage='<?php echo e(asset('utilisateur/imagestemplate/elgazala.jpg')); ?>'>
                                <img src='<?php echo e(asset('utilisateur/imagestemplate/elgazala.jpg')); ?>'alt="Featured image" width="300" height="150">
                            </div>
                        </div>
                        <div class="qt-item-content qt-card qt-the-content">
