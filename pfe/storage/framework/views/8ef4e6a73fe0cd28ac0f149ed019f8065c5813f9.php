                ...
                <div class="box-header">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-offset-5">
                            <a href="<?php echo e(route('equipe.create')); ?>" class="btn btn-success">Nouvelle Membre</a>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php $__currentLoopData = $equipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td> <?php echo e($equipe -> id); ?> </td>
                                <td><?php echo e($equipe -> nom); ?></td>
                                <td><?php echo e($equipe -> prenom); ?></td>
                                <td> <?php echo e($equipe -> poste); ?></td>
                                <td>
                                    <form action="<?php echo e(route('equipe.destroy',$equipe->id)); ?>" method="post">
                                        <?php echo e(csrf_field()); ?>

                                        <?php echo e(method_field('DELETE')); ?>

                                        <a href="<?php echo e(route('equipe.show',$equipe->id)); ?>" class="btn btn-primary">Details</a>
                                        <a href="<?php echo e(route('equipe.edit',$equipe->id)); ?>" class="btn btn-default">Editer</a>
