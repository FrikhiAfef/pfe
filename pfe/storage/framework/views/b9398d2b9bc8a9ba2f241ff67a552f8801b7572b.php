<?php $__env->startSection('contenu'); ?>
    <div id="maincontent" class="qt-main">
        ...
        <div class="qt-pageheader qt-negative">
            ...
            <div class="qt-header-bg" data-bgimage=<?php echo e(asset('utilisateur/imagestemplate/emissions/22.jpg')); ?>>
                <img src=<?php echo e(asset('utilisateur/imagestemplate/emissions/22.jpg')); ?> width="1600" height="700" alt="Featured image">
            </div>
        </div>
        <!-- HEADER CAPTION END ========================= -->
        <!-- ======================= CONTENT SECTION ======================= -->
                ...
                <div class="col s12 m12 l8">
                    ...
                    <div class="qt-part-archive-item qt-featured">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bottom">
                                <div class="qt-item-metas">
                                    <a class="qt-author-thumb" href="#author-url">
                                        <img src=<?php echo e(asset('utilisateur/imagestemplate/e1.jpg')); ?> alt="" width="30" height="30">
                                    </a>
                                    <div class="qt-texts">
                            ...
                            <div class="qt-header-bg" data-bgimage='<?php echo e(asset('utilisateur/imagestemplate\emissions\img11.jpeg')); ?>'>
                                <img src='<?php echo e(asset('utilisateur/imagestemplate\emissions\img11.jpeg')); ?> alt="Featured image'width="690" height="302">
                            </div>
                        </div>
                    ...
                    <div class="qt-part-archive-item">
                        <div class="qt-item-header">
                            ...
                            <div class="qt-header-bottom">
                                <div class="qt-item-metas">
                                    <a class="qt-author-thumb" href="#">
                                        <img src='<?php echo e(asset('utilisateur/imagestemplate/e2.jpg')); ?>' alt="" width="30" height="30">
                                    </a>
                                    <div class="qt-texts">
                            ...
                            <div class="qt-header-bg" data-bgimage='<?php echo e(asset('utilisateur/imagestemplate\emissions\img10.jpeg')); ?>'>
                                <img src='<?php echo e(asset('utilisateur/imagestemplate\emissions\img10.jpeg' )); ?>'alt="Featured image" width="690" height="302">
                            </div>
                        </div>
                        <div class="qt-item-content qt-card qt-the-content">
