<div class="qt-parentcontainer">
    ...
    <nav class="qt-menubar nav-wrapper qt-content-primary ">
        ...
        <ul class="qt-desktopmenu hide-on-xl-and-down">
            <li class="qt-logo-link"><a href="./" class="brand-logo qt-logo-text"><img src="<?php echo e(asset('utilisateur/imagestemplate/logo.png')); ?>" alt="Featured image" width="84" height="84"></a></li>
            <li><a href="#">Web Radio</a>
                <ul>
                    <li><a href="<?php echo e(route('emission')); ?>">Emissions</a></li>
                    <li><a href="<?php echo e(route('evenement')); ?>">Evénements</a></li>
                    <li><a href="<?php echo e(route('programme')); ?>">Programmes</a></li>
                    <li><a href="<?php echo e(route('podcast')); ?>">Podcasts</a></li>
                    <li><a href="<?php echo e(route('galerie')); ?>">Galeries</a></li>
            ...
            <li><a href="<?php echo e(route('actualite')); ?>">Actualités</a>
            <li><a href="<?php echo e(route('jumpin')); ?>">Jump In Incubator</a></li>
            <li><a href="<?php echo e(route('DigitalMediaLab')); ?>">Digital Media Lab</a></li>
            </li>
