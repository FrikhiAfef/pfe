<?php $__env->startSection('contenu'); ?>
    <div id="maincontent" class="qt-main">
        ...
        <div class="qt-pageheader qt-negative">
            ...
            <div class="qt-header-bg" data-bgimage="<?php echo e(asset('utilisateur/imagestemplate/emissions/slide.png')); ?>">
                <img src="<?php echo e(asset('utilisateur/imagestemplate/emissions/slide.png')); ?>" alt="Featured image" width="690" height="302">
            </div>
        </div>
        <!-- HEADER CAPTION END ========================= -->
                            ...
                            <div class="qt-item">
                                ...
                                <div class="qt-part-archive-item qt-part-archive-item-show qt-negative">
                                    <div class="qt-item-header">
                                        ...
                                        <div class="qt-header-mid qt-vc">
                                            <div class="qt-vi">
                                                <h5 class="qt-time"><?php echo e($programme->jours); ?> À <?php echo e($programme->heure); ?>h</h5>
                                                <h3 class="qt-ellipsis qt-t qt-title">
                                                    <a href="#read" class="qt-text-shadow"><?php echo e($programme->nomE); ?></a>
                                                </h3>
                                                <p class="qt-small qt-ellipsis">Animateur: <?php echo e($programme->nomAnim); ?> <?php echo e($programme->prenomAnim); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="qt-header-bg" data-bgimage="<?php echo e(asset('utilisateur/imagestemplate/emissions/img01.png')); ?>">
                                            <img src="<?php echo e(asset('utilisateur/imagestemplate/emissions/img01.png')); ?>" alt="Featured image" width="690" height="302">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="qt-header-mid qt-vc">
                                            <div class="qt-vi">
                                                <h4 class="qt-item-title qt-title">
                                                    <a href="#read" class="qt-ellipsis  qt-t"><?php echo e($programme->nomE); ?></a>
                                                </h4>
                                                <p class="qt-item-det">
                                                    <span class="qt-time"><?php echo e($programme->heure); ?></span><span class="qt-day qt-capfont"><?php echo e($programme->jours); ?></span>
                                                </p>
                                            </div>
                                        </div>
                                        <a href="#" class="qt-info bottom right"><i class="dripicons-information"></i></a>
                                        <div class="qt-header-bg" data-bgimage="<?php echo e(asset('utilisateur/imagestemplate/programmes/1.png')); ?>">
                                            <img src="<?php echo e(asset('utilisateur/imagestemplate/programmes/1.png')); ?>" alt="Featured image" width="690" height="302">
                                        </div>
                                    </div>
                                    <div class="qt-overinfo qt-paper">
                                        <p class="qt-item-det qt-accent">
                                            <span class="qt-time"><?php echo e($programme->heure); ?></span><span class="qt-am"></span><span class="qt-day qt-capfont"><?php echo e($programme->jours); ?></span>
                                        </p>
                                        <div class="qt-more">
                                            <p class="qt-ellipsis-2"><?php echo e($programme->nomE); ?> <?php echo e($programme->prenomE); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- SCHEDULE SHOW END ========================= -->
